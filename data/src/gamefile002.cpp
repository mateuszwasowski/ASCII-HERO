...
void gamefile002(){
	...
	map.open( "data/maps/map003.txt", ios::in | ios::out );
			...
			if ( key == 'w' || key == 'W'){
				...
				if ( cord_y_x[hero_y-1][hero_x] == '-' || cord_y_x[hero_y-1][hero_x] == '*' || cord_y_x[hero_y-1][hero_x] == '|' ){
					...
					if( temp_key == '*' ){
						...
						cord_y_x[20] = "This road is really solid!";
	...
	cout << "ERROR. Can't open map003.txt file!";
	key == getch();
